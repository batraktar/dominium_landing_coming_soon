...
ALLOWED_HOSTS = ['dominium.com.ua', 'www.dominium.com.ua', 'eventmanagment.pythonanywhere.com', '127.0.0.1']
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # Це для локальної розробки
